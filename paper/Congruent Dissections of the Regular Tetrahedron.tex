...
\path{results/S6_to_S12_edge_spectrum.json} and the $n=5$ residual-certificate
stack.  The general-convex $n=16$ statement is explicitly conditional on
...
\Cref{sec:intro}.  As stated there, the two general-convex hypotheses of
