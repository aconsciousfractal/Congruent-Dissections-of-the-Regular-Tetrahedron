...
\begin{conditionaltheorem}[$n=5$ convex reduction to the accidental-even metric residual]\label{thm:n5}
...
Here ``conditional theorem'' follows the paper's evidence taxonomy for the ambient
convex face-to-face programme; the script-level H-labels listed above are audit
labels, not additional public hypotheses.
\end{conditionaltheorem}
